...
 'EvalMethod' - Provides ability to evaluate performance by different means.  Supported methods: AllYears, RandomOrder
...
 'Output' - The output generated by the program.  Supported modes: Normal, Files, Verbose, GiantCsv.  Files outputs CSVs for each simulation.  Verbose gives details of each simulation and GiantCsv outputs similar data in CSV format.
...
NOTE: GiantCsv will NOT create a file, only outputting the data to the command line.
